...
import org.clueminer.demo.gui.AbstractClusteringViewer;
 ...
 * @param <C>
 */
public class FacesWrapper<E extends Instance, C extends Cluster<E>>
        extends AbstractClusteringViewer<E, C> implements TaskListener, DatasetViewer<E, C> {

    private FacePanel<E, C> viewer;

    public FacesWrapper(Map<String, Dataset<E>> data) {
        this(new DataProviderMap<>(data));
    }

    public FacesWrapper(DataProvider<E> provider) {
        super(provider);
    }
